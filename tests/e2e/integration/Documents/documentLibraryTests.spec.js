...
// TODO: To remove when we ensure it works perfectly
describe('Documents scripts', () => {
  ...
  it('empty the documentLibrary and database then create note', () => {
    ...
    // Created note does not contains suffix '(1)'
    cy.contains('[data-test=file]', 'createdNote').should('exist')
    cy.contains('[data-test=file]', 'createdNote (1)').should('not.exist')
  })
})
