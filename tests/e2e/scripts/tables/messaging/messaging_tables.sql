...
INSERT INTO `Messaging_MessageFolder` (`folderId`, `userId`, `folderName`, `type_`, `parentFolderId`) VALUES (19654701,332442,'Boîte de réception',1,0),(19654702,332442,'Envoyés',3,0),(19654703,332442,'Corbeille',4,0),(19654704,332442,'Brouillons',2,0),(19662701,332442,'sous-dossier',5,0),(19662702,332442,'sous-sous-dossier',5,19662701),(19662703,332442,'Mon autre sous-dossier',5,0);/*!40000 ALTER TABLE `Messaging_MessageFolder` ENABLE KEYS */;
UNLOCK TABLES;
