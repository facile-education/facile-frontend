...
export default {
  ...
  methods: {
    ...
    formatPreviousContent (content) {
      return '</br><details><summary>' +
        this.$t('Messaging.CreateMessageModal.previousContentHeader', {
          dateLabel: dayjs(this.originMessage.sendDate, DATE_EXCHANGE_FORMAT).format('DD/MM/YYYY HH:mm'),
          senderName: this.originMessage.sender.userName
        }) +
        '</summary>' +
