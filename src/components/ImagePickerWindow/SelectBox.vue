<template>
  ...
  >
    ...
    >
      <span
        class="drag-point point-lt"
        @mousedown="pointMouseDown('drag-lt', $event)"
      />
      <span
        class="drag-point point-lb"
        @mousedown="pointMouseDown('drag-lb', $event)"
      />
      <span
        class="drag-point point-rt"
        @mousedown="pointMouseDown('drag-rt', $event)"
      />
      <span
        class="drag-point point-rb"
        @mousedown="pointMouseDown('drag-rb', $event)"
      />
    </div>
  </div>
</template>
