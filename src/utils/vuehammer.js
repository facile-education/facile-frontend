...
const subGestures = [
  'panstart', 'panend', 'panmove', 'pancancel', 'pinchstart', 'pinchmove',
  'pinchend', 'pinchcancel', 'pinchin', 'pinchout', 'pressup', 'rotatestart',
  'rotatemove', 'rotateend', 'rotatecancel'
]
...
export const VueHammer = {
    ...
    Vue.directive('hammer', {
      beforeMount: (el, binding) => {
        ...
        if (config.customEvents?.[event]) {
          ...
          if (recognizerType === 'tap' || recognizerType === 'pinch' ||
              recognizerType === 'press' || recognizerType === 'rotate') {
  ...
  guardDirections (options) {
    ...
    if (typeof dir === 'string') {
      ...
      if (directions.indexOf(dir) > -1 && Object.prototype.hasOwnProperty.call(Hammer, hammerDirection)) {
