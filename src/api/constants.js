...
// TODO get URL / applications in a dynamic way / understand why dashboard cannot be called with default app
const APPLICATION_MANAGER_URL = USER_PREFIX + DEFAULT_APP + '?p_p_id=gestionApps_WAR_gestionApplicationsportlet&p_p_lifecycle=2&p_p_state=exclusive&p_p_mode=view&p_p_cacheability=cacheLevelPage&controlPanelCategory=portlet_gestionApps_WAR_gestionApplicationsportlet'
const DASHBOARD_MANAGER_URL = USER_PREFIX + DEFAULT_APP + '?p_p_id=gestionDashboard_WAR_gestionDashboardportlet&p_p_lifecycle=2&p_p_state=exclusive&p_p_mode=view&p_p_cacheability=cacheLevelPage&controlPanelCategory=portlet_gestionDashboard_WAR_gestionDashboardportlet'
